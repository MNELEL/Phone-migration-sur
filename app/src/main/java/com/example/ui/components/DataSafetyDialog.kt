            ...
            LazyColumn(
                ...
                item {
                    DataSafetyItem(
                        ...
                        description = "נסרקים גודל הקבצים והספירה הכוללת בלבד לחישוב נפח אחסון. תוכן התמונות נשמר במכשיר או בענן Firebase מוצפן בבחירת המשתמש.",
                        icon = Icons.Default.CheckCircle,
                        tag = "מטא-דאטה ואחסון מוצפן"
                    )
                }

                item {
                    DataSafetyItem(
                        title = "הצפנה ואבטחה (TLS / AES-256)",
                        description = "כל הנתונים המועברים לענן Firebase מוצפנים מקצה לקצה בתקשורת מאובטחת. נתוני המשתמש אינם נמכרים ואינם משותפים עם מפרסמים.",
                        icon = Icons.Default.Lock,
                        tag = "הצפנה במעבר ובמנוחה"
                    )
                }
            }
        },
